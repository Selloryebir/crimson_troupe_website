...
`images/folio/normal/` 与 `images/folio/crimson/` 是本次人工明确要求纳入的成对活页高清修复素材，各 13 张无损 WebP。它们保留官方参考原版的独特设计，不属于项目原创资产；仅 8 张普通版被当前里站内容快照引用，猩红版尚无页面消费者。该实验例外不改变其他剧目资产的原创要求，也不表示获得发布许可；具体来源、SHA-256 和未解决的权利状态见 `docs/sources/folio-cover-restoration.md`。
