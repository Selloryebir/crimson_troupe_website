...
export const performances = {
  ...
  'frost-deer-and-snow-doe-nuova-volsinii-1084-0125': {
    ...
    status: 'completed',
    locationId: 'volsinii',
    effectiveDateTime: { calendar: 'terra', year: 1084, month: 2, day: 12, time: '18:45' },
  ...
  'one-hundred-and-one-days-londinium-1084-0903': {
    ...
    status: 'scheduled',
    locationId: 'londinium',
    effectiveDateTime: { calendar: 'terra', year: 1084, month: 11, day: 18, time: '19:30' },
  ...
  'the-carnival-londinium-1084-1009': {
    ...
    status: 'scheduled',
    locationId: 'londinium',
    effectiveDateTime: { calendar: 'terra', year: 1085, month: 2, day: 20, time: '19:00' },
    productionIds: ['the-carnival'],
    ticketAvailability: {
      state: 'on-sale',
  ...
  'light-of-heria-trimount-1085-0530': {
    ...
    status: 'scheduled',
    locationId: 'zwillingsturme',
    effectiveDateTime: { calendar: 'terra', year: 1085, month: 5, day: 22, time: '19:00' },
    productionIds: ['light-of-heria', 'ode-au-triomphe'],
    ticketAvailability: { state: 'not-on-sale' },
  },
