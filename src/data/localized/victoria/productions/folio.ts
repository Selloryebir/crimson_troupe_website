...
export const victoriaFolioProductions = {
  'der-ring': createFolioProductionContent('victoria', 'der-ring', {
  ...
  'one-hundred-and-one-days': createFolioProductionContent('victoria', 'one-hundred-and-one-days', {
  ...
  'the-carnival': createFolioProductionContent('victoria', 'the-carnival', {
  ...
  'ode-au-triomphe': createFolioProductionContent('victoria', 'ode-au-triomphe', {
  ...
  'lone-wander': createFolioProductionContent('victoria', 'lone-wander', {
  ...
  'wonderland-in-dream': createFolioProductionContent('victoria', 'wonderland-in-dream', {
  ...
  'frost-deer-and-snow-doe': createFolioProductionContent('victoria', 'frost-deer-and-snow-doe', {
  ...
  'light-of-heria': createFolioProductionContent('victoria', 'light-of-heria', {
