...
export const ursusMessages = {
  ...
  ticketing: {
    ...
    finishWorkshop: {
      eyebrow: 'ОТДЕЛКА БИЛЕТА',
      title: 'Отделка в билетной мастерской',
      copy: 'Выберите один способ печатной отделки, не меняющий сведений билета. Он будет применён ко всем памятным билетам этого раунда.',
      legend: 'Выберите отделку этого раунда',
      requiredHint:
        'После выбора билет можно скачать или распечатать. До конца раунда выбор можно изменить.',
      selectedAnnouncement: 'Выбрано: {label}. Билеты этого раунда оформлены заново.',
      choices: {
        'deckle-edge': {
          title: 'Неровный срез',
          description: 'Добавляет неровную линию среза справа, не сдвигая основные сведения.',
        },
        'registration-shift': {
          title: 'Смещение приводки',
          description: 'Слегка смещает вторую рамку, как при ручной печати в мастерской труппы.',
        },
        'ticket-punch': {
          title: 'Тройной прокол',
          description: 'Добавляет три прокола на левой полосе, вдали от номера и составной печати.',
        },
      },
    },
    adjustments: {
