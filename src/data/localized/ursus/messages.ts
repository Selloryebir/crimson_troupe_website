...
export const ursusMessages = {
  ...
  ticketing: {
    ...
    stampInspector: {
      summary: 'Рассмотреть составную печать этого раунда',
      title: 'Нанесённые отметки',
      copy: 'В увеличенном виде наложены только элементы реально пройденных событий. Непройденные маршруты не показаны пустыми ячейками.',
      previewAlt: 'Увеличенный вид составной печати этого раунда',
      endingComponent: 'Элемент маршрута: {label}',
      journeyComponent: 'Фактура обработки: {label}',
    },
    finishWorkshop: {
