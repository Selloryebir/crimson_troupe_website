...
export const columbiaMessages = {
  ...
  ticketing: {
    ...
    partnerPageIntroduction:
      'The troupe website has passed this basket to its partner platform. This preview offers only a reliable fallback destination.',
    partnerUnavailableTitle: 'Connection flow is not open yet',
    partnerUnavailableCopy:
      'This preview contacts no remote service and creates no transaction. You can safely return to the official basket.',
