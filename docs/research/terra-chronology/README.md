...
本研究也是[演出创意主动审查](../../guides/creative-content-review.md)的证据输入。年鉴文件变化会使当前审查记录失效，智能体需检查受影响的创意关系；这不意味着来源更新自动改写网站排期或已采纳前提。

优先阅读[巡演与双站时间关联研究](temporal-analysis.md)：包含剧团身份链、螺旋桨天堂案例、16个地区影响窗口、1084可达性与7类失效快照候选。已采纳部分已迁入正式责任文档，参见[项目时间前提](../../project/temporal-context.md)与[时间内容审核方法](../../guides/temporal-content-review.md)；研究候选及日期分歧不因此成为正式产品规则。
